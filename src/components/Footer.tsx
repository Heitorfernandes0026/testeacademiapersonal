...
const Footer = () => {
  ...
  return (
    <footer className="py-16 bg-card border-t border-primary/20 relative overflow-hidden grain-overlay">
      {/* Background Effects */}
      <div 
        className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px]"
        style={{
          background: 'radial-gradient(ellipse, hsl(0 85% 50% / 0.08) 0%, transparent 60%)',
        }}
      />
      
      {/* Diagonal accent */}
      <div 
        className="absolute top-0 right-0 w-[150px] h-[200px] bg-primary/5"
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col items-center gap-10">
          ...
          >
            {[
              ...
              <motion.a
                ...
                className="w-14 h-14 border border-border/50 bg-background/50 flex items-center justify-center hover:border-primary hover:text-primary hover:bg-primary/10 transition-all duration-300 group"
          ...
          <motion.button
            onClick={scrollToTop}
            className="w-12 h-12 border border-border/50 bg-background/50 flex items-center justify-center hover:border-primary hover:text-primary hover:bg-primary/10 transition-all duration-300"
